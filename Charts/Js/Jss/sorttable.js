...
jQuery.fn.addSortWidget = function(options){
	var defaults = {
		img_asc: "../Картинки/asc_sort.gif",
        img_desc: "../Картинки/desc_sort.gif",
		img_nosort: "../Картинки/no_sort.gif",
	};
	...
	$("th", $destElement).each(function(index){ // to each header cell (INDEXZAP is useful while sorting)
        $("<img>")                              // create image that allows you to sort by specific column 
            ...
            .on('click', function(){
                ...
                rows.sort(function(a, b){               
                    ...
                    var m = $("td:eq(" + index + ")", a).text(); // get column you needed by using INDEXZAP of th element (closure)
